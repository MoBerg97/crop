...
mapvalues(fin$crop, from = crop_names, to = cropnms)
...
fin2 = fin
mapvalues(fin2$crop, from= c('Getreidemit','Getreideohne','Brotgetreidearten','Wintergetreide','Futtergetreide','Sommergetreide','Titricale'), to= c('Getreide','Getreide','Getreide','Getreide','Getreide','Getreide','Getreide'))
mapvalues(fin2$crop, from= c('Winterweizen','Sommerweizen','Getreideganz','Hartweizen','Weizen'), to= c('Weizen','Weizen','Weizen','Weizen','Weizen'))
mapvalues(fin2$crop, from= c('Roggenmit','Roggen'), to=c('Roggen','Roggen'))
mapvalues(fin2$crop, from= c('Gerste','Wintergerste','Sommergerste'), to= c('Gerste','Gerste','Gerste',))
mapvalues(fin2$crop, from= c('Körnermais','Silomais'),to= c('Mais','Mais'))
mapvalues(fin2$crop, from= c('Frühkartoffeln','Kartoffeln','Spätkartoffeln'),to= c('Kartoffeln','Kartoffeln','Kartoffeln'))
mapvalues(fin2$crop, from= c('Zuckerrüben','Runkelrüben'),to= c('Rüben','Rüben'))
mapvalues(fin2$crop, from= c('Winterraps','Sommerraps','Sonnenblumen'),to= c('RapsSonne','RapsSonne','RapsSonne'))
mapvalues(fin2$crop, from= c('Leguminosen','Erbsen','Ackerbohnen','Klee','Luzerne','Süßlupinen'),to= c('Leguminosen','Leguminosen','Leguminosen','Leguminosen','Leguminosen','Leguminosen'))
mapvalues(fin2$crop, from= c('Wiesen','Weiden','Feldgras','Rauhfutter'),to= c('Gras','Gras','Gras','Gras'))
