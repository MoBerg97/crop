...
fin2 = fin
fin2$crop = mapvalues(fin2$crop, from= c('Getreidemit','Getreideohne','Brotgetreidearten','Wintergetreide','Futtergetreide','Sommergetreide','Titricale'), to= c('Getreide','Getreide','Getreide','Getreide','Getreide','Getreide','Getreide'))
...
# TODO consolidate rows with allover same values, but different dt.ha
fin2 = fin2 %>%
...
# TODO Durchschnittsertrag je wichtige Feldfrucht pro Kreis
...
# schauen ob sich crops Anbauzeiten decken oder ergänzen
# schauen ob was intesiverer Bearbeitung bedarf
