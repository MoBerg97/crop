...
The graphics show, that a cumulation of wheat, rye, oats to one group called cereals would be better comparable to other major crops. Other crop categories like rapeseed and sunflower can be disregarded due to low yield and unsuitable assignment to other categories.
...
ggplot() +
  ...
  geom_point(data=filter(mn_cropjahr,mn_dt>100),aes(x=year,y=mn_dt, group = crop, colour = crop)) +
  geom_line(data=filter(mn_cropjahr,mn_dt>100),aes(x=year,y=mn_dt, group = crop, colour = crop)) +
  ...
  geom_point(data=filter(mn_cropjahr,mn_dt<100), aes(x=year,y=mn_dt, group=crop)) +
  geom_line(data=filter(mn_cropjahr,mn_dt<100), aes(x=year,y=mn_dt, group=crop)) +
