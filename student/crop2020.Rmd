...
#TODO ERROR: `mapping`must be created by `aes()`
...
cropyearspan3 = fin %>%
  ...
  group_by(gen) %>%
  summarise(mn_dt=mean(dtha))
tm_shape(nrw) + tm_borders(lwd = 2, col='grey1') + tm_compass() + tm_scale_bar() + tm_shape(cropyearspan1) + tm_polygons('mn_dt', palette='RdYlBu', breaks = c(0,20,40,60,80,100,120),id='dt/ha')
tm_shape(nrw) + tm_borders(lwd = 2, col='grey1') + tm_compass() + tm_scale_bar() + tm_shape(cropyearspan2) + tm_polygons('mn_dt', palette='RdYlBu', breaks = c(0,20,40,60,80,100,120),id='dt/ha')
tm_shape(nrw) + tm_borders(lwd = 2, col='grey1') + tm_compass() + tm_scale_bar() + tm_shape(cropyearspan3) + tm_polygons('mn_dt', palette='RdYlBu', breaks = c(0,20,40,60,80,100,120), id='dt/ha')
```
