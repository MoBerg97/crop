...
fin = fin %>%
  mutate(cropcat = plyr::mapvalues(crop, 
            from= c('Getreidemit','Getreideohne','Brotgetreidearten','Wintergetreide','Futtergetreide','Sommergetreide','Triticale'), 
  ...
  mutate(cropcat = plyr::mapvalues(crop, 
            from= c('Leguminosen','Erbsen','Ackerbohnen','Klee','Luzerne','Süßlupinen'),
